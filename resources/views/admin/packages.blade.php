                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="p-4 md:p-5 space-y-4">
                                    <form action="{{ route('admin.updatePackage', $package->id) }}" method="POST">
                                        ...
                                        <div class="mb-4">
                                            <label for="cost"
                                                class="block text-gray-700 text-sm font-bold mb-2">Cost</label>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea id="description" name="description"
                                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">{{ $package->description }}</textarea>
                                        </div>
                                        <div class="mb-4">

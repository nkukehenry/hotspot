            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-gray-50/30 dark:bg-gray-900/10">
                        <th class="px-4 py-1.5 text-[9px] font-black text-gray-400 uppercase">Site</th>
                        <th class="px-4 py-1.5 text-[9px] font-black text-gray-400 uppercase">Package</th>
                        <th class="px-4 py-1.5 text-[9px] font-black text-gray-400 uppercase text-right">Stock</th>
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-700 text-[11px]">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors {{ $item->available_count <= 100 ? 'bg-red-50/40 dark:bg-red-900/10' : '' }}">
                        <td class="px-4 py-1.5 font-bold text-gray-900 dark:text-white">{{ $item->site_name }}</td>
                        <td class="px-4 py-1.5 text-gray-600 dark:text-gray-400 font-bold uppercase">{{ $item->package_name }}</td>
                    ...
                    @empty
                    <tr>
                        <td colspan="4" class="px-4 py-6 text-center text-gray-400 italic">No packages found for this company.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
